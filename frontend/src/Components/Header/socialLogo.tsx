...
function SocialLogo() {
    ...
    return (
        <span id="logo_social">
            <img onClick={langue == 'fr' ? ()=>{} :toggleLangue} className="logo_soc" src={require('../../assets/logo/flag_fr.png')} />
            ...
            <img onClick={langue == 'en' ? ()=>{} :toggleLangue} className="logo_soc" src={require('../../assets/logo/flag_uk.png')} />
