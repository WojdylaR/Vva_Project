function TextPresentation(){
    return(
        <div id="TextPresentation">
            <p id="p_1" className="para"><h2 className="sous_titre_txt">Notre <span className="red">Image</span><img id="notre_image" className="img_tittle" src={require('../../assets/notre_image.png')} alt="notre_image" /></h2>
                <p>
                ...
                <p id="p_2" className="para"><h2 className="sous_titre_txt">La<span className="red"> vidéo</span> au XXIeme<img id="la_video" className="img_tittle" src={require('../../assets/la_video.png')} alt="la_video" /></h2>
                <p>
                ...
                <p id="p_3" className="para"><h2 className="sous_titre_txt">L’<span className="red">humain</span> avant tout<img id="qualite" className="img_tittle" src={require('../../assets/qualite.png')} alt="qualite" /></h2>
                <p>
