function TextPresentation(){
    return(
        <div id="TextPresentation">
            <p id="p_1" className="para"><h2 className="sous_titre">Notre <span className="red">Image</span> </h2>
                <p>
                ...
                <p id="p_2" className="para"><h2 className="sous_titre">La<span className="red"> vidéo</span> au XXIeme</h2>
                <p>
                ...
                <p id="p_3" className="para"><h2 className="sous_titre">L’<span className="red">humain</span> avant tout</h2>
                <p>
